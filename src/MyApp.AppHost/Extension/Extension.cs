namespace MyApp.AppHost.Extension;

public static class Extension
{
    public static IResourceBuilder<PostgresDatabaseResource> AddPostgresContainer<TBuilder>(this TBuilder builder)
    ...
    public static IResourceBuilder<RedisResource> AddRedisContainer<TBuilder>(this TBuilder builder)
        where TBuilder : IDistributedApplicationBuilder
    {
    ...
    public static IResourceBuilder<KeycloakResource> AddKeycloakContainer<TBuilder>(this TBuilder builder)
        where TBuilder : IDistributedApplicationBuilder
    {
    ...
    public static IResourceBuilder<MailPitContainerResource> AddMailPitContainer<TBuilder>(this TBuilder builder)
        where TBuilder : IDistributedApplicationBuilder
    {
