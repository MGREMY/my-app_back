...
public static class AppDbContextExtension
{
    extension(AppDbContext dbContext)
    {
        ...
        /// </remarks>
        public async Task<bool> MigrateAndExecSqlScriptAsync(
            ...
            CancellationToken ct = default)
        {
            ...
            if (!sqlScriptDirectoryExists)
                logger.LogInformation("No SqlScript folder found. No SqlScript will be executed");
            ...
            catch (Exception e)
            {
                ...
                logger.LogCritical("Rollback all changes made to avoid conflicts or lost data");
